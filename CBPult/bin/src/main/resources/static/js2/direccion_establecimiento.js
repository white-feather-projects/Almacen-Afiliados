...
window.addEventListener('load', function(){
	...
	var sector_urbanizacion = document.querySelector("#sector_urbanizacion");
	var avenida_calle = document.querySelector("#avenida_calle");
	var codigo_postal = document.querySelector("#codigo_postal");
	var localidad = document.querySelector("#localidad");
	var nombre_inmueble = document.querySelector("#nombre_inmueble");
	var punto_referencia = document.querySelector("#punto_referencia");
	
	/////////////////////////////////////////////////////////////////////////
	
	document.getElementById("ciudad").innerHTML =`<option value='San José'>San José</option>
	...
	document.getElementById("municipio").innerHTML =`<option value='Carmen'>Carmen</option>
	...
	estado.addEventListener('blur', ()=>{
		...
		if(estado.value === "San José"){
			...
			document.getElementById("ciudad").innerHTML =`<option value='Alajuela'>Alajuela</option>
			...
			document.getElementById("ciudad").innerHTML =`<option value='Cartago'>Cartago</option>
			...
			document.getElementById("ciudad").innerHTML =`<option value='Heredia'>Heredia</option>
			...
			document.getElementById("ciudad").innerHTML =`<option value='Liberia'>Liberia</option>
			...
			document.getElementById("ciudad").innerHTML =`<option value='Puntarenas'>Puntarenas</option>
			...
			document.getElementById("ciudad").innerHTML =`<option value='Limón'>Limón</option>
	...
	ciudad.addEventListener('blur', ()=>{
		...
		if(ciudad.value === "San José"){
			...
			document.getElementById("municipio").innerHTML =`<option value='Escazú'>Escazú</option>
				<option value='San Antonio'>San Antonio</option>
				<option value='San Rafael'>San Rafael</option>`;
			
		}else if(ciudad.value === "Desamparados"){
			
			document.getElementById("municipio").innerHTML =`<option value='Desamparados'>Desamparados</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santiago'>Santiago</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Marcos'>San Marcos</option>
				<option value='San Lorenzo'>San Lorenzo</option>
				<option value='San Carlos'>San Carlos</option>`;
			
		}else if(ciudad.value === "Aserrí"){
			
			document.getElementById("municipio").innerHTML =`<option value='Aserrí'>Aserrí</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Colon'>Colon</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Guadalupe'>Guadalupe</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santa Ana'>Santa Ana</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Alajuelita'>Alajuelita</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Isidro'>San Isidro</option>
				<option value='San Rafael'>San Rafael</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Ignacio de Acosta'>San Ignacio de Acosta</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Juan'>San Juan</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Vicente'>San Vicente</option>
				<option value='San Jeronimo'>San Jeronimo</option>
				<option value='Trinidad'>Trinidad</option>`;
			
		}else if(ciudad.value === "Montes de Oca"){
			
			document.getElementById("municipio").innerHTML =`<option value='San Pedro'>San Pedro</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Pablo'>San Pablo</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santa María'>Santa María</option>
				<option value='Jardin'>Jardin</option>
				<option value='Copey'>Copey</option>`;
			
		}else if(ciudad.value === "Curridabat"){
			
			document.getElementById("municipio").innerHTML =`<option value='Curridabat'>Curridabat</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Isidro del General'>San Isidro del General</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Alajuela'>Alajuela</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Ramón'>San Ramón</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Grecia'>Grecia</option>
				<option value='San Isidro'>San Isidro</option>
				<option value='San José'>San José</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Mateo'>San Mateo</option>
				<option value='Desmonte'>Desmonte</option>
				<option value='Jesús María'>Jesús María</option>`;
			
		}else if(ciudad.value === "Atenas"){
			
			document.getElementById("municipio").innerHTML =`<option value='Atenas'>Atenas</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Naranjo'>Naranjo</option>
				<option value='San Miguel'>San Miguel</option>
				<option value='San José'>San José</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Palmares'>Palmares</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Orotina'>Orotina</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Quesada'>Quesada</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Zarcero'>Zarcero</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Sarchi Norte'>Sarchi Norte</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Upala'>Upala</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Los Chiles'>Los Chiles</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Rafael'>San Rafael</option>
				<option value='Buenavista'>Buenavista</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Oriental'>Oriental</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Paraíso'>Paraíso</option>
				<option value='Santiago'>Santiago</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Tres Ríos'>Tres Ríos</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Juan Viñas'>Juan Viñas</option>
				<option value='Tucurrique'>Tucurrique</option>
				<option value='Pejibaye'>Pejibaye</option>`;
			
		}else if(ciudad.value === "Turrialba"){
			
			document.getElementById("municipio").innerHTML =`<option value='Turrialba'>Turrialba</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Pacayas'>Pacayas</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Tejar'>Tejar</option>
				<option value='San Isidro'>San Isidro</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Heredia'>Heredia</option>
				<option value='Mercedes'>Mercedes</option>
				<option value='San Francisco'>San Francisco</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Barva'>Barva</option>
				<option value='San Pedro'>San Pedro</option>
				<option value='San Pablo'>San Pablo</option>
				<option value='San Roque'>San Roque</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santo Domingo'>Santo Domingo</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santa Barbara'>Santa Barbara</option>
				<option value='San Pedro'>San Pedro</option>
				<option value='San Juan'>San Juan</option>
				<option value='Jesús'>Jesús</option>
				<option value='Santo Domingo'>Santo Domingo</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Antonio'>San Antonio</option>
				<option value='Ribera'>Ribera</option>
				<option value='Asuncion'>Asuncion</option>`;
			
		}else if(ciudad.value === "Flores"){
			
			document.getElementById("municipio").innerHTML =`<option value='San Joaquín de Flores'>San Joaquín de Flores</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Puerto Viejo'>Puerto Viejo</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Liberia'>Liberia</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Nicoya'>Nicoya</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Santa Cruz'>Santa Cruz</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Bagaces'>Bagaces</option>
				<option value='Fortuna'>Fortuna</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Filadelfia'>Filadelfia</option>
				<option value='Palmira'>Palmira</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Cañas'>Cañas</option>
				<option value='Palmira'>Palmira</option>
				<option value='San Miguel'>San Miguel</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Juntas'>Juntas</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Tilaran'>Tilaran</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Carmona'>Carmona</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='La Cruz'>La Cruz</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Hojancha'>Hojancha</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Puntarenas'>Puntarenas</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Espiritu Santo'>Espiritu Santo</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Buenos Aires'>Buenos Aires</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Miramar'>Miramar</option>
				<option value='Uníon'>Uníon</option>
				<option value='San Isidro'>San Isidro</option>`;
			
		}else if(ciudad.value === "Osa"){
			
			document.getElementById("municipio").innerHTML =`<option value='Puerto Cortes'>Puerto Cortes</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Quepos'>Quepos</option>
				<option value='Savegre'>Savegre</option>
				<option value='Naranjito'>Naranjito</option>`;
			
		}else if(ciudad.value === "Golfito"){
			
			document.getElementById("municipio").innerHTML =`<option value='Golfito'>Golfito</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='San Vito'>San Vito</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Parrita'>Parrita</option>`;
			
		}else if(ciudad.value === "Corredores"){
			
			document.getElementById("municipio").innerHTML =`<option value='Corredor'>Corredor</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Jaco'>Jaco</option>
				<option value='Tarcoles'>Tarcoles</option>`;
			
		}else if(ciudad.value === "Limón"){
			
			document.getElementById("municipio").innerHTML =`<option value='Limón'>Limón</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Guapiles'>Guapiles</option>
				<option value='Jiménez'>Jiménez</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Siquirres'>Siquirres</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Bratsi'>Bratsi</option>
			...
			document.getElementById("municipio").innerHTML =`<option value='Matina'>Matina</option>
				<option value='Battan'>Battan</option>
				<option value='Carrandi'>Carrandi</option>`;
			
		}else if(ciudad.value === "Guácimo"){
			
			document.getElementById("municipio").innerHTML =`<option value='Guácimo'>Guácimo</option>
				<option value='Mercedes'>Mercedes</option>
	...
	municipio.addEventListener('blur', ()=>{
		console.log("municipio", municipio.value);
