...

{
  ...
  if(document.getElementById('tenenciaVivienda').value == 'ALQUILADA' || document.getElementById('tenenciaVivienda').value == 'PROPIA' || document.getElementById('tenenciaVivienda').value == 'OTROS'){
