...
$(document).ready(function() {
    ...
    elt.tagsinput( {
        ...
        itemValue:'value', itemText:'text', typeaheadjs:[ {
	        ...
	        {
	            name: 'cities', displayKey: 'text', source: cities.ttAdapter()
	        }
        ]
    });
    ...
    $('input.color-class').maxlength( {
        alwaysShow: true, threshold: 10, warningClass: "label label-success", limitReachedClass: "label label-danger"
    });
    
    $('input.position-class').maxlength( {
        alwaysShow: true, placement: 'top-left'
    });
