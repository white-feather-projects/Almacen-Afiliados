...
/**
 * <p>Clase Java para crearZonaWSResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="crearZonaWSResponse">
 *   &lt;complexContent>
...
@XmlType(name = "crearZonaWSResponse", propOrder = {
    "_return"
})
public class CrearZonaWSResponse {
