...
/**
 * <p>Clase Java para procesarArchivosClienteWSResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="procesarArchivosClienteWSResponse">
 *   &lt;complexContent>
...
@XmlType(name = "procesarArchivosClienteWSResponse", propOrder = {
    "_return"
})
public class ProcesarArchivosClienteWSResponse {
